                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Update Sub Agents Page</h4>

                                    <form action="{{route('managesubagent.update',$updatesubagent->id)}}" method="POST" class="outer-repeater">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="agentname" id="agentname" value="{{$updatesubagent->name}}" placeholder="Enter Agent Name...">
                                                </div>
                                                {{-- Agent Name --}}

                                                {{-- Main Agent Name --}}
                                                <div class="form-group">
                                                    <label for="agent_id">Main Agent Name :</label>
                                                    <input type="text" class="form-control" name="agent_id" id="agent_id" value="{{App\Models\Agent::find($updatesubagent->agent_id)->name}}" placeholder="Enter Agent Name...">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="region" id="region" value="{{$updatesubagent->region}}" placeholder="Enter Agent Name...">
                                                </div>

                                                <div class="form-group">
                                                    <label for="township">Township :</label>
                                                    <input type="text" class="form-control" name="township" id="township" value="{{$updatesubagent->township}}" placeholder="Enter Agent Name...">
                                                </div>

                                                {{-- phno --}}
                                                 <div class="form-group">
                                                    <label for="phno">Ph No :</label>
                                                    <input type="text" class="form-control" name="phno" id="phno" value="{{$updatesubagent->phno}}" placeholder="Enter Phone Number ...">
                                                </div>
                                                {{-- phno --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="address" id="address" value="{{$updatesubagent->address}}" placeholder="Enter Address...">
                                                </div>
                                                {{-- address --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" id="formemail" value="{{$updatesubagent->email}}" placeholder="Enter your Email...">
                                                </div>
                                                {{-- Email --}}
                                                <br>
                                                {{-- Password --}}
                                                {{-- <div class="form-group">
                                                    ...
                                                    <input type="password" name="password" id="password" value="{{$updateagent->password}}" placeholder="Enter Password..." class="form-control">
                                                </div> --}}
                                                {{-- Password --}}
