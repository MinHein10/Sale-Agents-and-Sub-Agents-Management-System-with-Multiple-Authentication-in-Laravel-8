                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Update Agents Page</h4>

                                    <form action="{{route('manageagent.update',$updateagent->id)}}" method="POST" class="outer-repeater">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="agentname" id="agentname" value="{{$updateagent->name}}" placeholder="Enter Agent Name...">
                                                </div>
                                                {{-- Agent Name --}}
                                                ...
                                                {{-- phno --}}
                                                 <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="phno" id="phno" value="{{$updateagent->phno}}" placeholder="Enter Phone Number ...">
                                                </div>
                                                {{-- phno --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="address" id="address" value="{{$updateagent->address}}" placeholder="Enter Address...">
                                                </div>
                                                {{-- address --}}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" name="email" class="form-control" id="formemail" value="{{$updateagent->email}}" placeholder="Enter your Email...">
                                                </div>
                                                {{-- Email --}}
                                                <br>
                                                {{-- Password --}}
