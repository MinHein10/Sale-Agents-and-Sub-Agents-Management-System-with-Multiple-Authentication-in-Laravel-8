                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Update Categories Page</h4>

                                    <form action="{{route('category.update',$updatecategory->id)}}" method="POST" class="outer-repeater">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div data-repeater-list="outer-group" class="outer">
                                            <div data-repeater-item class="outer">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="description" value="{{$updatecategory->description}}" id="description" placeholder="Enter Description...">
                                                </div>
                                                {{-- Description--}}
